...
public class ItauTestsApi{
	...
	@Test
	public void t_05deveIncluirPetPerry() {				
	     given()
	     .log().all()
	...
	@Test
	public void t_06venderPerryParaAnaMaria() {				
	     given()
	     .log().all()
	...
	@Test
	public void t_06venderSnoopyParaRodrigoMendes() {				
	     given()
	     .log().all()
	...
	@Test
	public void t_07alterarStatusSnoopy() {				
	 	     given()
	 	     .log().all()
	...
	@Test
	public void t_08alterarStatusPerry() {				
	 	     given()
	 	     .log().all()
	...
	@Test
	public void t_09consultarOrdemPerry() {				
	 	     given()
	 		.when()
	...
	@Test
	public void t_09consultarOrdemSnoopy() {				
	 	     given()
	 		.when()
